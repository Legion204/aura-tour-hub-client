        ...
        <div>
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <Link to={'/'} className=" md:text-4xl font-Playfair font-bold"><span className="flex text-center items-center md:items-start justify-center"><img className="w-10 md:w-16" src={logo} alt="" /><span className="self-center">AuraTour-Hub</span></span></Link>
                </div>
